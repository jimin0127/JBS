...
%>
	...
	<div class="container">
		<div class = "row">
			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td colspan="2"> <%= jbs.getJbsTitle() %>
					</tr>
					
					<tr>
						<td style="width: 20%;">작성자</td>
						<td colspan="2"> <%= jbs.getUserID() %>
					</tr>
					
					<tr>
						<td style="width: 20%;">작성일자</td>
						<td colspan="2"> <%= jbs.getJbsDate().substring(0, 11) + jbs.getJbsDate().substring(11, 13) + "시" + jbs.getJbsDate().substring(14, 16) + "분" %>
					</tr>
	
					<tr>
						<td style="width: 20%;">글내용</td>
						<td colspan="2" style="min-height:200px; text-align:left"> <%= jbs.getJbsContent()%>
					</tr>
				</tbody>
			</table>
			...
			<a href="deleteAction.jsp?jbsID= <%= jbsID %>" class= "btn btn-primary">수정</a>
			<%}%>
